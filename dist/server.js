...
server.tool(
  ...
  "Create a new polygon (regular polygon) in Figma",
  {
    ...
    pointCount: z.number().int().min(3).optional().describe("Number of sides/points of the polygon (default: 3, min: 3). e.g., 5 for pentagon, 6 for hexagon"),
    ...
    fillColor: z.object({
      ...
      a: z.number().min(0).max(1).optional().describe("Alpha/Opacity component (0-1)")
